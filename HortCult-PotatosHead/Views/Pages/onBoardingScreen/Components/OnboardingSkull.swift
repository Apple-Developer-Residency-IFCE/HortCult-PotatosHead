...
struct OnboardingSkull_Previews: PreviewProvider {
    static var previews: some View {
        OnboardingScreen(header: "hortFruitLight",centerImage: "amico 2",
                         ...
                         secondaryText: "Com o HortCult, voce pode acompanhar a sua horta domestica de forma simples e facil.",
                         actionMainButton: {print("ola")}, mainButtonType: .one,
                         hidenSecondaryButton: true,
                         actionSecondaryButton: {print("Segundo botao")})
    }
}
